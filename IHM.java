...
public class IHM {
	...
	private void initialize() {
		...
		cbJ1.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent arg0) {
				controler.j1tricheurStateChange(cbJ1.isSelected());
		...
		cbJ2.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				controler.j2tricheurStateChange(cbJ2.isSelected());
			}
		});
	...
	public void updateJ1(String nom, int score, boolean isTricheur) {
		textFieldScoreJ1.setText("" + score);
		lblJoueur1.setText(nom);
		cbJ1.setSelected(isTricheur);
	}

	public void updateJ2(String nom, int score, boolean isTricheur) {
		textFieldScoreJ2.setText("" + score);
		lblJoueur2.setText(nom);
		cbJ2.setSelected(isTricheur);
	}
