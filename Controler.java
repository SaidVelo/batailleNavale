...
public class Controler {
	...
	public void refreshScreen() {
		...
		// Update du joueur 1
		ihm.updateJ1(pb.getJ1().getNom(), pb.getJ1().getScorePartie(), pb.getJ1().isTricheur());
		// Update du joueur 2
		ihm.updateJ2(pb.getJ2().getNom(), pb.getJ2().getScorePartie(), pb.getJ2().isTricheur());
	...
	public void j1tricheurStateChange(boolean selected) {
		pb.getJ1().setTricheur(selected);

		refreshScreen();

	}

	public void j2tricheurStateChange(boolean selected) {
		pb.getJ2().setTricheur(selected);
